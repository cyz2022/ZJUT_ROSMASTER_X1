        ...
        while line_detect.VideoSwitch==True :
            ...
            while flag_all !=0: 
                ...
                if cnt_target == 4 and cnt_corss == 3 and time.time() - start_rush_time > 0.4 and left_front == 1 and right_front == 1 and left_middle == 1 and right_middle == 1  and finsh_flag == 1:
                    print("43 sensor")
                    process_speed_longroad_new_43(30)
                    finsh_flag = 1
                    flag_all =0
                if cnt_target == 4 and cnt_corss == 1 and left_front == 1 and right_front == 1 and left_middle == 1 and right_middle == 1  and finsh_flag == 1:
                    print("43 sensor")
                ...
                if cnt_target == 4 and cnt_corss == 9 and time.time() - start_rush_time > 0.4 and left_front == 1 and right_front == 1 :#finsh
                    ...
                    finsh_flag = 1
                    flag_all =0
                if cnt_target == 5 and cnt_corss == 0  :#finsh time.time() - start_rush_time > 0.6
                    print("50 sensor")
                    process_speed_longroad_new_50_1(50)
                    finsh_flag = 1
                    flag_all =0
                ...
                if cnt_target == 4 and cnt_corss == 14 and time.time() - start_rush_time > 0.3 and left_front == 1 and right_front == 1 and left_middle == 1 and right_middle == 1:#finsh
                    print("413 sensor")
                    process_speed_longroad_new_414(30)
                    flag_all =0
                    speed_gear = 1    

                if cnt_target == 4 and cnt_corss == 15 and time.time() - start_rush_time > 0.1:#finsh
                    print("415 sensor")
                    process_speed_longroad_new_415(30)
                    flag_all =0
                if cnt_target == 4 and cnt_corss == 16 and time.time() - start_rush_time > 0.1:#finsh
                    print("416 sensor")
                    process_speed_longroad_new_415(30)
                    flag_all =0
                if cnt_target == 4 and cnt_corss == 17 and time.time() - start_rush_time > 0.5 and left_front == 1 and right_front == 1 and left_middle == 1 and right_middle == 1:#finsh
                    print("417 sensor")
                    process_speed_longroad_new_417(50)
                    flag_all =0
                if cnt_target == 4 and cnt_corss == 18 and time.time() - start_rush_time > 0.1 :#finsh
                    print("418 sensor")
                    process_speed_longroad_new_418(30)
                    flag_all =0
                if cnt_target == 4 and cnt_corss == 19 and time.time() - start_rush_time > 0.2 :#finsh
                    print("419 sensor")
                    process_speed_longroad_new_419(30)
                    flag_all =0
                #speed 
                if cnt_target == 5 and cnt_corss == 1 and time.time() - start_rush_time > 0.3 and left_front == 1 and right_front == 1 and left_middle == 1 and right_middle == 1 :#finsh
                    print("51 sensor")
                    process_speed_longroad_new_510_1(10)
                    flag_all =0
                if cnt_target == 5 and cnt_corss == 2 and time.time() - start_rush_time > 0.1 and left_front == 1 and right_front == 1 and left_middle == 1 and right_middle == 1 :#finsh
                    print("51 sensor")
                    process_speed_longroad_new_510(20)
                    flag_all =0
                if cnt_target == 5 and cnt_corss == 3 and time.time() - start_rush_time > 0.5 and left_front == 1 and right_front == 1 and left_middle == 1 and right_middle == 1 :#finsh
                    print("52 sensor")
                ...
                if cnt_target == 5 and cnt_corss == 5 and time.time() - start_rush_time > 0.3 and left_front == 1 and right_front == 1 and left_middle == 1 and right_middle == 1 :#finsh
                    ...
                    flag_all =0
                if cnt_target == 5 and cnt_corss == 6 and time.time() - start_rush_time > 0.3 and left_front == 1 and right_front == 1 and left_middle == 1 and right_middle == 1 :#finsh
                    print("55 sensor")
                    process_speed_longroad_new_550(30)
                    flag_all =0
                #speed
            ...
            elif cnt_target == 5 and cnt_corss == 6 and clock_flag:
                print(5,5)
                clock_flag = 0
                flag_all = 1
                bot.set_car_motion(0, 0, 0)
            ...
            elif cnt_target == 5 and cnt_corss == 7 and clock_flag and finsh_flag:
                print(5, 7)
                finsh_flag = 0
                clock_flag = 0
                flag_all = 1
