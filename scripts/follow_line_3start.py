...
class LineDetect:
    def __init__(self):
        ...
        self.rear_prev_error = 0.0        #self.hsv_text = rospkg.RosPack().get_path("yahboomcar_linefollw")+"/scripts/LineFollowHSV.text"
    ...
    if line_detect.VideoSwitch==False:rospy.spin()
        ...
        while line_detect.VideoSwitch==True :
            ...
            while flag_all !=0: 
                ...
                if time.time() - start_vertical_time > 1.5 and flag_vertical == 0 and cnt_target == 2 and cnt_corss == 4:
                    bot.set_car_motion(0,0,0)
                ...
                if pitch > 5 and cnt_target == 5 and cnt_corss == 0 and finsh_flag == 0:
                    low_platform(5)
                    print("go platform3")
                    finsh_flag = 1
                end = time.time()
            ...
            if cnt_target == 1 and cnt_corss == 1 and clock_flag:                
                ...
                #time.sleep(1)
                #finsh_flag = 0
                #target_angle = calculate_angle(old_angle,35,1)
      ...
      #          print("NB")
                ...
                cnt_target += 1
                cnt_corss = 0
            elif cnt_target == 5 and cnt_cross == 1 and clock_flag:
                print(5,1)
                clock_flag = 0
                flag_all = 1
                bot.set_car_motion(0,0,0)
