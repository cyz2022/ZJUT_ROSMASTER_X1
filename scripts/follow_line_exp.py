    ...
    if line_detect.VideoSwitch==False:rospy.spin()
        ...
        while line_detect.VideoSwitch==True :
            ...
            while flag_all !=0: 
                ...
                if pitch > 5 and cnt_target == 6 and cnt_corss == 0 and finsh_flag == 0:
                    middle_platform()
                    print("down t mountain")
                    finsh_flag = 1
                    speed_gear = 4
            ...
            if cnt_target == 1 and cnt_corss == 1 and clock_flag:                
            ...
            elif cnt_target == 4 and cnt_corss == 0 and clock_flag:
                print(4,0)
                clock_flag = 0
                flag_all = 1
                ...
                cnt_corss = 0
                cnt_target += 1
                speed_gear = 3#ÉÏÆÂ,Ö±½Óµ¹³µµ½Â·¿Ú£¬×ªÍä
                ...
                if cnt_target == 7 and cnt_corss == 6 and clock_flag:
                    ...
                    cnt_corss += 1
                    #¹ý¼õËÙ´ø
                if cnt_target == 7 and cnt_corss == 7 and clock_flag:
                    print(7,7)
                    clock_flag = 0
                    flag_all = 1
                    cnt_corss += 1
                    bot.set_car_motion(0, 0, 0)
                    turn_cross(90, 1)
                if cnt_target == 7 and cnt_corss == 8 and clock_flag:
                    print(7,8)
                    clock_flag = 0
                    flag_all = 1
                    cnt_corss += 1
                    bot.set_car_motion(0, 0, 0)
                    turn_cross(90, 1)
                if cnt_target == 7 and cnt_corss == 9 and clock_flag:
                    print(7,9)
                    clock_flag = 0
                    flag_all = 1
                    cnt_corss += 1
                    ...
                    speed_gear = 4
                    # ¹ý¼õËÙ´ø
                if cnt_target == 7 and cnt_corss == 10 and clock_flag:
                    print(7, 10)
                    speed_gear = 1
                    clock_flag = 0
                    flag_all = 1
                ...
                if cnt_target == 7 and cnt_corss == 10 and clock_flag:
                    ...
                    speed_gear = 1
                    # ¹ý¼õËÙ´ø
            elif road_select == 3 or road_select == 5:
                if cnt_target == 7 and cnt_corss == 6 and clock_flag:
                    print(7,6)
                    clock_flag = 0
                    flag_all = 1
