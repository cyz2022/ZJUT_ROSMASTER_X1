    ...
    if line_detect.VideoSwitch==False:rospy.spin()
        ...
        while line_detect.VideoSwitch==True :
            ...
            while flag_all !=0: 
                ...
                if cnt_target == 2 and cnt_corss == 1 and (left_mid == 0 and right_mid == 0 or time.time() - mountain_time > 3) and finsh_flag == 0:
                    old_angle = go_t_mountain()
                ...
                if pitch > 5 and cnt_target == 3 and cnt_corss == 4 and finsh_flag == 0:
                    low_platform(3)
                    print("go platform3")
                    finsh_flag = 1
